        ...
        <div class="col-md-3">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body box-profile">
              ...
              <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Location IoT:</strong> &nbsp; {{Auth::user()->location}}</li>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <input type="text" class="form-control" id="location" placeholder="Location" value="{{ Auth::user()->location }}" name="location">
